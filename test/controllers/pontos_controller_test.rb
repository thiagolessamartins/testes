...
class PontosControllerTest < ActionController::TestCase
  ...
  test "should create ponto" do
    assert_difference('Ponto.count') do
      post :create, ponto: { data: @ponto.data, questao_id: @ponto.questao_id, solucao: @ponto.solucao, staus: @ponto.staus, titulo: @ponto.titulo }
    end
  ...
  test "should update ponto" do
    patch :update, id: @ponto, ponto: { data: @ponto.data, questao_id: @ponto.questao_id, solucao: @ponto.solucao, staus: @ponto.staus, titulo: @ponto.titulo }
    assert_redirected_to ponto_path(assigns(:ponto))
  end
